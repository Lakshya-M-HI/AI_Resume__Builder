    ...
    return (
        <div>
            ...
            <section className="flex flex-col items-center justify-center mx-auto max-md:mx-2 max-md:px-2 max-w-5xl w-full text-center rounded-2xl py-20 md:py-24 bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/banners/image-2.png')] bg-cover bg-center bg-no-repeat">
                <h1 className="text-2xl md:text-3xl font-medium text-white max-w-2xl">Create a Professional Resume Instantly with AI</h1>
                <div className="h-[3px] w-32 my-1 bg-linear-to-l from-transparent to-white"></div>
                <p className="text-sm md:text-base text-white max-w-xl">
                    Generate ATS-optimized resumes, tailored summaries, skill highlights, and job-specific bullet points in seconds. Customize, preview, and export polished PDFs ready to apply.
                </p>
